...
@Component
public class SumFromTransactionsByStoreCityScenarioMethods {
    @Autowired
    ...
    private Float sqlCalculateTransactionSumForStores(List<SqlStore> stores) {
        float sum = 0.0f;
        for (SqlStore store : stores) {
    ...
    private Float mongoCalculateTransactionSumForStores(List<MongoStore> stores) {
        float sum = 0.0f;
        for (MongoStore store : stores) {
    ...
    private Float neoCalculateTransactionSumForStores(List<NeoStore> stores) {
        float sum = 0.0f;
        for (NeoStore store : stores) {
