...
@Component
public class AnonymousBuyScenarioMethods {
    ...
    @ExecTimeMeasure
    public SqlOrder sqlCreateOrder(SqlCart cart) {
    ...
    @ExecTimeMeasure
    public MongoOrder mongoCreateOrder(MongoCart cart) {
    ...
    @ExecTimeMeasure
    public NeoOrder neoCreateOrder(NeoCart cart) {
