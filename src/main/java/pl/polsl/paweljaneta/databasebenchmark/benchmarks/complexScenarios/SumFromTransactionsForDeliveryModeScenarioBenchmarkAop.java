...
import pl.polsl.paweljaneta.databasebenchmark.testScenarios.impl.complexScenarios.SumFromTransactionsForDeliveryModeScenario;
...
public class SumFromTransactionsForDeliveryModeScenarioBenchmarkAop {
    ...
    @Autowired
    private SumFromTransactionsForDeliveryModeScenario scenarioClass;
